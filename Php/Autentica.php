...
{
	$row = mysql_num_rows($queryadm);
	$id = mysql_result($queryadm, $row, "email");
    ...
    {
        $row = mysql_num_rows($queryven);
        $id = mysql_result($queryven, $row, "email");
        ...
        {
            $row = mysql_num_rows($querycom);
            $id = mysql_result($querycom, $row, "email");
