...
if($_COOKIE['tipo_utente']==3)
{
    ...
    {
        $querycom = "UPDATE utenti SET credito = utenti.credito - '".$row->prezzo ."' WHERE email='".$row->carrello.compratore ."'";

        $queryven = "UPDATE utenti SET credito = utenti.credito + '".$row->prezzo ."' WHERE email='".$row->auto.venditore ."'";
