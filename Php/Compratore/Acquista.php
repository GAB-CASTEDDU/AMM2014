...
if($_COOKIE['tipo_utente']==3)
{
    ...
    $queryvis = mysql_query("SELECT * FROM carrello INNER JOIN auto ON carrello.id = auto.id AND carrello.compratore ='".$_COOKIE["utente"]."'") or die("query non riuscita".mysql_error());
