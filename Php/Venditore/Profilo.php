                ...
                <table id="table-content">
                    <tr>
                        ...
                        <td id="center">
                            ...
                            ?>
                            <br><p>Nessun veicolo in vendita al momento. Riprova tra poco</p><br><br>
                            <?
                            }
                                    ...
                                    <tr>
                                        <td>
                                            <table id="table-vis">
                                                ...
                                                <tr>
                                                    <td><a href="Rimuovi.php?rimuovi=<?echo $row2->id?>" id="cestino">Rimuovi annuncio</a></td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            ?>
                            <br><p>Nessun veicolo venduto al momento. Riprova tra poco</p><br><br>
                            <?
                            }
